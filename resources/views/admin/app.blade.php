...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | Expart Home</title>
...
<div class="wrapper">
    ...
    <div class="leftside-menu">
        <a href="{{route('dashboard')}}" class="logo logo-light">
            <span class="logo-lg">
                <img src="{{URL::to('backend/images/logo-light.png')}}" alt="logo" style="height: 50px;">
            </span>
            <span class="logo-sm">
                <img src="{{URL::to('backend/images/logo-light.png')}}" alt="small logo">
            </span>
        </a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <script>document.write(new Date().getFullYear())</script> © Expart Home</b>
                    </div>
                </div>
            </div>
        </footer>
